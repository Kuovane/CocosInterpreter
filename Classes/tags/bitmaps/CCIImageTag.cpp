...
Texture2D * CCIImageTag::getTexture(){
...
void CCIImageTag::createTextureWithRGBAImage(UI8 * RGBAImageData){
    ...
    this->texture2d->initWithData(RGBAImageData, this->width*this->height*4, Texture2D::PixelFormat::RGBA8888, this->width, this->height,Size(this->width, this->height));
...
void CCIImageTag::createTextureWithImageAndAlpha(Image *image,UI8 *alpha){
    ...
    if(hasAlpha)
    {
        ...
        this->texture2d = new Texture2D();
        this->texture2d->initWithData(imageRGBA, height*width*4, Texture2D::PixelFormat::RGBA8888, width, height, Size(this->width, this->height));
    }
